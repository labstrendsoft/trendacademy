	...
	return (
		<div className="bg-gradient-to-r from-[#161A31] to-[#080B1A] text-white py-16 px-4 md:px-8">
			<div className="max-w-3xl mx-auto px-4 md:px-0">
				<h2 className="text-2xl md:text-3xl font-bold text-start sm:text-center mb-12">
				...
				<p className="text-start sm:text-center mt-12 max-w-lg sm:mx-auto text-sm md:text-base">
